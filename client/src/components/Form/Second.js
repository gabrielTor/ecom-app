...
export default function Second({elements, setElements, setPage}) {
  ...
  return (
    ...
    <Flex justify='center' pb='20%'>
        <Box border='0px' w='50%' h='fit-content' m='2%'>

            <FormControl isRequired mb='5%'>
                <FormLabel>Title:</FormLabel>
                <Input type='text' name='title' placeholder='your title' defaultValue={elements.title} onChange={handleChange}/>
            ...
            <FormControl isRequired mb='5%'>
                ...
                <InputGroup>
                    <InputLeftElement
                        fontWeight='bold'
                        children='$'/>
                    <Input type='number' name={'price'} defaultValue={elements.price} onChange={handleChange}/>
                </InputGroup>
            ...
            <FormControl mb='5%'>
                ...
                <Input type='number' name={'stock'} defaultValue={elements.stock} onChange={handleChange}/>
            ...
            <FormControl>
                ...
                <InputGroup>
                    <Input type='text' placeholder='make sure to click add' value={value} onChange={(e)=>setValue(e.target.value)}/>
